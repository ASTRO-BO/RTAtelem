...
BOOST_PYTHON_MODULE(CTACameraTriggerData_ext)
{
         ...
         class_<RTATelem::CTACameraTriggerData, bases<RTATelem::CTACamera> >("CTACameraTriggerData", init<std::string>())
              ...
              .def("setIndexOfCurrentTriggeredTelescopes", &RTATelem::CTACameraTriggerData::setIndexOfCurrentTriggeredTelescopes)
              .def("getIndexOfCurrentTriggeredTelescopes", &RTATelem::CTACameraTriggerData::getIndexOfCurrentTriggeredTelescopes)
