...
class CTACameraConv1 : public RTATelem::CTACamera {
...
public:
	...
	CTACameraConv1(string packetConfig, string tmInputFileName, string tmOutputFileName);

	CTACameraConv1(string packetConfig);
